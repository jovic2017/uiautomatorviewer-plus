...
Now, let's take a look currently implemented functions, from left to right is system settings, Step adding and modifying, waiting for elements to display, clicking elements, saving text, input text, adding assertions, deleting nodes, generating code, refreshing test cases and Debug tool
![image](https://github.com/user-attachments/assets/fab44e36-9b54-4387-8059-b07eb5b41163)
### System settings, which can set the generated class names, debug servers, code templates, code output paths and test data.
...
### Wait for the element display. Select the element you want to operate on the screen, and the text of the current element will be displayed by default. If there is no text for the element, use xpath to locate it. The default is to wait for the selected element to display, you can choose to wait for the relative element of that element to display too.
![image](https://github.com/user-attachments/assets/8d8aa48d-8772-4aae-912f-583082d3b67d)
### Clicking an element also uses text locate by default. You can click on the selected element, or on other relative node elements of that element. You can also set to click if a certain element displayed.
![image](https://github.com/user-attachments/assets/da8aec2f-7120-45f5-bc9f-c2b6eb6b6037)
### Save the text. Searching the target element can help you finding the correct target element. If there is a resource id, it is used for locate by default. If not, other text relative positioning or custom xpath can be used. Click to find the target element, and the xpath and target element text will be displayed below. Then enter the key and description to save the text
![image](https://github.com/user-attachments/assets/b35f3768-c7b5-43b0-b8df-2a50bfbcb317)
### Input text and searching for the target element can help you finding the correct target element for the text to be input. Clicking on the input box for the text will bring up the second and third interfaces, allowing you to select the text to be input
